...
<div x-data="budgetForm()">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500">Edit Anggaran</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mt-4">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Perbarui informasi kategori anggaran.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form method="POST" action="{{ route('budget.update', $budget) }}" class="space-y-8 divide-y divide-gray-200">
                @csrf
                @method('PUT')
                        ...
                        <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="kro_code" id="kro_code" value="{{ old('kro_code', $budget->kro_code) }}" required
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="ro_code" id="ro_code" value="{{ old('ro_code', $budget->ro_code) }}" required
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="initial_code" id="initial_code" value="{{ old('initial_code', $budget->initial_code) }}" required
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="account_code" id="account_code" value="{{ old('account_code', $budget->account_code) }}" required
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <textarea name="description" id="description" rows="4" required
                                              class="max-w-lg block w-full shadow-sm focus:ring-navy-500 focus:border-navy-500 sm:text-sm border-gray-300 rounded-md @error('description') border-red-500 @enderror">{{ old('description', $budget->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="pic" id="pic" value="{{ old('pic', $budget->pic) }}" required
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" name="budget_allocation" id="budget_allocation"
                                               value="{{ old('budget_allocation', $budget->budget_allocation) }}" required min="0" step="0.01"
                    ...
                    <div class="px-6 py-5">
                        ...
                        <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="reference" id="reference" value="{{ old('reference', $budget->reference) }}" required
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="reference2" id="reference2" value="{{ old('reference2', $budget->reference2) }}"
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="text" name="reference_output" id="reference_output" value="{{ old('reference_output', $budget->reference_output) }}"
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="number" name="length" id="length" value="{{ old('length', $budget->length) }}" required min="1"
