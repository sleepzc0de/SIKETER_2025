...
@section('content')
<div class="max-w-4xl mx-auto" x-data="roleEditForm()">
    <!-- Header -->
    <div class="mb-8">
            ...
            <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-4 text-sm font-medium text-gray-500">Edit Role</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mt-4">
            <h1 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                Edit Role: {{ $roleMeta['display_name'] }}
            </h1>
        </div>
    </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="display_name" id="display_name" value="{{ old('display_name', $roleMeta['display_name']) }}" required
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3" x-model="form.description"
                              ...
                              placeholder="Deskripsi singkat tentang role ini...">{{ old('description', $roleMeta['description']) }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
...
function roleEditForm() {
    return {
        form: {
            ...
            display_name: '{{ old('display_name', $roleMeta['display_name']) }}',
            description: '{{ old('description', $roleMeta['description']) }}'
        },
