...
@section('content')
<div class="max-w-3xl mx-auto" x-data="permissionForm()">
    <!-- Header -->
    <div class="mb-8">
            ...
            <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-4 text-sm font-medium text-gray-500">Tambah Permission</span>
                    </div>
                </li>
            </ol>
        </nav>
...
function permissionForm() {
    return {
        ...
        generateDisplayName() {
            if (!this.form.display_name || this.form.display_name === this.convertToDisplayName(this.form.name)) {
                this.form.display_name = this.convertToDisplayName(this.form.name);
            }
        },
